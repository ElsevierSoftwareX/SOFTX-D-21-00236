classdef TA_Plate_HX_Nonideal <TA_HX_Nonideal
    ...
    methods
        %% constructor
        function obj = TA_Plate_HX_Nonideal(name,system,length,D,y0,phi,solid,Q)
            obj@TA_HX_Nonideal(name,system,length,solid,Q)
            obj.Diameter=D;
            obj.Y0=y0;
        ...
        function T_solid=Calculate_Solid_Temperature(obj)
            ...
            k=Modrefpropm('L','T',T_m,'P',p_m/1000,gas);
            alpha=0.0001*Modrefpropm('%','T',T_m,'P',p_m/1000,gas);%m2/s

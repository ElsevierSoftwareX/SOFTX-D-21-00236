classdef TA_Circular_Stack_Nonideal_LPlinked <TA_Stack_Nonideal
    ...
    methods
        %% constructor
        function obj = TA_Circular_Stack_Nonideal_LPlinked(name,system,length,A,D,phi,solid)
        ...
        function  set.A_Solid(obj,value)
            ...
            obj.Lp=0.5*obj.Diameter*(1/obj.Gas_Area_Ratio^0.5-1);
        end

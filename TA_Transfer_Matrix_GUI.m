classdef  TA_Transfer_Matrix_GUI<TA_Component
    ...
    properties
        ...
        M11(1,1) double  % an item of the transfer matrix by the index
        M12(1,1) double
        M21(1,1) double
        M22(1,1) double
    ...
    methods
        function obj=TA_Transfer_Matrix_GUI(name,system,M11,M12,M21,M22)
        ...
        function [PUT_After,H_after]=run_component(obj,P_U_T_in,H_before,locstart)
            ...
            PU=P_U_T_in(1:2)';
            PUT_After=[(([obj.M11,obj.M12;obj.M21,obj.M22]+[1,0;0,1])*PU)',P_U_T_in(3)];
